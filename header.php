					...
					<div class="col-md-4">
						...
						<div class="right-menu text-right">
				      	...
				      	<?php $facebook = get_field('facebook', 'options'); ?>
								...
								<?php endif ?>
								<?php if (!wp_is_mobile()): ?>
									<a href="#" class="btn btn-round btn-login">ingresar</a>
									<!-- <a href="<?php echo $ingreso; ?>" class="btn btn-round eModal-1">ingresar</a> -->
									<div class="clearfix"></div>
									<?php if ($recuperar!=""): ?>
										<a href="<?php echo $recuperar; ?>" class="recovery-pass">Recuperar contraseña</a>
									<?php endif ?>								
								<?php else: ?>								
									<a href="#" class="social btn-login" target="_blank"><i class="fa fa-user" aria-hidden="true"></i></a>
								<?php endif ?>
