...
function bootstrap_theme_enqueue_scripts() {
	...
	wp_enqueue_style( 'grayscale-style', $template_url . '/css/grayscale.min.css' );
  wp_enqueue_style( 'felipe-style', $template_url . '/css/felipe.css' );
...
function add_custom_sizes(){
	add_theme_support('post-thumbnails');
	add_image_size('header', 1920, 808, array( 'center', 'center' ) );
	add_image_size('conoce', 340, 516, array( 'center', 'center' ) );
	add_image_size('custom-size', 220, 180, array( 'center', 'center' ) );
	add_image_size('saludable-home', 360, 327, array( 'center', 'center' ) );
	add_image_size('universitaria-home', 500, 999, array( 'center', 'center' ) );
}
